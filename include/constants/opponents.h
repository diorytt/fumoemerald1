...
#define TRAINER_OTTO                        855 // 104
#define TRAINER_SCOTTIE                     856 // 104

// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is only space for 9-2 additional trainers before trainer flag space overflows
